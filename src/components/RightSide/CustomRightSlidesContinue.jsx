...
const CustomRightSlidesContinue = ({ logo, title, episodesLeft }) => {
    return (
        <div  className='outline-0 border-[#2D2E34] border-[2px] p-[8px] mr-[20px] h-[150px] rounded-[12px] bg-[#16181E]'>
...
export default CustomRightSlidesContinue;