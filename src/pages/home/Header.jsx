  ...
  return (
    <div className='Header flex justify-between h-[45px]'>
        <div className='flex h-[42px] mt-[8px]'>
            <div className={`mt-[8px] font-semibold mr-[50px] text-[16px] text-[#00B9AE] border-y-[#00B9AE] border-b-[3px]`}><a href='/'>Movies</a></div>
            <div className={`mt-[8px] font-semibold mr-[50px] text-[16px] text-[#F9F9F9]`}><a href='streaming'>Streaming Services</a></div>
            <div className={`mt-[8px] font-semibold text-[16px] text-[#F9F9F9]`}><a href='series'>Series</a></div>
        </div>
